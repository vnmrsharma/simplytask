...
const AuthForm: React.FC = () => {
  ...
  const { signIn, signUp, signInWithGoogle, resetPassword, error, clearError, validatePassword, validateEmail } = useAuth();
          ...
          {(mode === 'signin' || mode === 'signup') && (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed font-semibold transition-all duration-200 bg-white text-gray-700"
              >
                {isSubmitting ? (
                  <LoadingSpinner size="sm" />
                ) : (
